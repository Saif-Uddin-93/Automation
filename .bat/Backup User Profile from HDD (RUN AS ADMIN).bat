...
SET /p SRC_DRIVE="Enter Drive letter: "
SET /p DEST_COMPUTER="Enter target computer name: "
::SET USER=%USERNAME%
SET /p USER="Enter username: "

SET SRC_DESKTOP=%SRC_DRIVE%:\BACKUPS\%USER%\Desktop
SET SRC_DOCUMENTS=%SRC_DRIVE%:\BACKUPS\%USER%\Documents
SET SRC_DOWNLOADS=%SRC_DRIVE%:\BACKUPS\%USER%\Downloads
SET SRC_MUSIC=%SRC_DRIVE%:\BACKUPS\%USER%\Music
SET SRC_PICTURES=%SRC_DRIVE%:\BACKUPS\%USER%\Pictures
SET SRC_VIDEOS=%SRC_DRIVE%:\BACKUPS\%USER%\Videos
SET SRC_FONTS=%SRC_DRIVE%:\Users\%USER%\Windows\Fonts
...
SET DEST_FONTS=\\%DEST_COMPUTER%\c$\Users\%USER%\Windows\Fonts

::backup bookmarks
xcopy /Y "%SRC_DRIVE%:\BACKUPS\%USER%\AppData\Local\Google\Chrome\User Data\default" "\\%DEST_COMPUTER%\c$\Users\%USER%\AppData\Local\Google\Chrome\User Data\default\bookmarks"
